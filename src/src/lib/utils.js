...
// Condensed activity grid for the share card — last N days, active or not.
// Deliberately binary rather than a 5-level gradient: GitHub's public events
// API tells us a day had activity, not how many commits, so faking levels
// of "intensity" would be inventing precision the data doesn't have.
export const buildMiniHeatmap = (activeDays, days = 70) => {
  ...
  for (let i = days - 1; i >= 0; i--) {
    ...
    cells.push(activeSet.has(key) ? 1 : 0)
  }
  return cells
}